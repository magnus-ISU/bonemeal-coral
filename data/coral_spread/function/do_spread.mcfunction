# Debug: found coral block
tellraw @a [{"text":"[Coral Spread] ","color":"aqua"},{"text":"Found coral block! Spreading coral in 3x3x3 cube...","color":"green"}]
...
tellraw @a [{"text":"[Coral Spread] ","color":"aqua"},{"text":"Spread complete!","color":"green"}]
